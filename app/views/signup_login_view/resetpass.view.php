    ...
    <div id="FORM-SYSTEM">
        <form action="<?= URLPATH ?>resetpass/r" method="post">
            <div class="form-header">
                ...
                <p>Porfavor escriba su nueva contraseña. (minimo 8 characteres)resetpass/ressetthe
            </div>
            ...
            <h3 class="form-link-login">¿Ya recuerdas tu contraseña?
                <a href="<?= URLPATH ?>login" class="links-color"> inicia sesion</a>
            </h3>
            <h3 class="form-link-login">¿No tienes una cuenta?
                <a href="<?= URLPATH ?>singup" class="links-color"> crear una ahora</a>
            </h3>
