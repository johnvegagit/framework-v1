...
class SignupController
{
    public function signupDataCntr(string $name, string $surname, string $username, string $email, string $pwd, string $cnfrpwd)
    {
        ...
        if (validate_empty($name)) {
            $errors['name'] = '<span class="auth-input-msg-err"><i class="bi bi-exclamation-triangle-fill"></i> Enter your name.</span>';
        ...
        if (validate_empty($surname)) {
            $errors['surname'] = '<span class="auth-input-msg-err"><i class="bi bi-exclamation-triangle-fill"></i> Enter your surname.</span>';
